describe('Quote Form Defaults', function() {
  ...
  it('defaults to using dimensions', () => {
    ...
    expect(/active/.test(dimensionsCheckbox.getAttribute('class'))).toBe(true);
  });
  it('defaults dimensions UOM to cm', () => {
    const dimensionsUOM = b.element('.dimensions-uom .Select-value-label span');
  ...
  it('defaults hazardous material to false', () => {
    ...
    expect(/active/.test(hazardousMaterial.getAttribute('class'))).toBe(false);
  });
  ...
  it('defaults insurance required to false', () => {
    ...
    expect(/active/.test(insuranceRequired.getAttribute('class'))).toBe(false);
  });
});
